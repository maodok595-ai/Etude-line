...
- **Color-Coded Semesters (Oct 17, 2025)**: Professor dashboard now features visually distinct semester headers with color coding matching the student dashboard experience. S1 (Semester 1) displays with orange/amber styling (#ff9800 on light orange background), while S2 (Semester 2) uses violet/purple (#764ba2 on light purple background). Each semester header includes a 4px left border and subtle background color for improved visual hierarchy and quick identification.
